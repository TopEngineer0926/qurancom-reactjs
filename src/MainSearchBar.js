...
import {
  SurahContext, OffsetContext, CurrentPageContext, ChosenVerseFlagContext, ChosenVerseAndPageContext, QueryContext,
      ...
      <div className="container">
        ...
        <div className="row d-flex justify-content-center mt-5 mb-2">
          ...
          <form className="searchbox" >
            ...
            <Link to={`/search?q=${Text}`} onClick={(e) => {
              if (Text.length === 0) { e.preventDefault() } setQuery(Text); setResultPage(1); setTimeout(function () {
        ...
        <div className="row d-flex justify-content-center">
          <ul className="quicklinks align-items-center" hidden="hidden">
