                  ...
                  <div className="col-2 col-sm-2">
                    <MenuList className={classes.root}>
                      ...
                      <StyledMenuItem>
                        ...
                        <FacebookShareButton url={`${mem.text_madani} - ${mem.translations[0].text}`} style={{fontSize: 13}}>Facebook</FacebookShareButton>
                      </StyledMenuItem>
                      <StyledMenuItem>
                        ...
                        <WhatsappShareButton url={`${mem.text_madani} - ${mem.translations[0].text}`} style={{fontSize: 13}}>Whatsapp</WhatsappShareButton>
                      </StyledMenuItem>
                    </MenuList>
                  ...
                  <div className="col-10 col-sm-10">
                    <div className="ayatbox">
                      ...
                      {Array.isArray(mem.translations) ? mem.translations.map((trans, i) =>
                        <div key={`Translation_${i}`} className="translation-box TranslationFontChanger" style={{marginLeft: 50}}>
